...
exports.createAccount = (event, user) => {
	// console.log("accout main process", args);

	let sql =
		"INSERT INTO account(accountNo,name,phone,address,balance) VALUES?";
...
const addAccountSummary = (transection) => {
	let sql =
		"INSERT INTO accountStatement(accountId,date,transectionAmount, description,transectionType,lastBalance) VALUES?";
	// console.log('addAccountSummary ',transection);
	// transection is object
	// we need array of values to be query in db
